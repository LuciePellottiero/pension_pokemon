...
public class Lokhlass extends AbstractPokemon implements TypeEau, TypeGlace{
	...
	public Lokhlass(final String nom, IPokemon.Sexe sexe, float poids, float taille, int age) {
		super("Lokhlass", new LinkedList<IPokemon.PokemonType>(Arrays.asList(TYPES)), nom, sexe, poids, taille, age, LOKHLASS_CRI);
	}
