...
public class Herbizarre extends AbstractPokemon implements TypePlante, TypePoison{
	...
	public Herbizarre(String nom, IPokemon.Sexe sexe, int poids, int taille, int age) {
		super("Herbizarre", new LinkedList<IPokemon.PokemonType>(Arrays.asList(TYPES)), nom, sexe, poids, taille, age, HERBIZARRE_CRI);
	}
