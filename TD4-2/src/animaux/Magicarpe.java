...
public class Magicarpe extends AbstractPokemon implements TypeEau{
	...
	public Magicarpe(String nom, IPokemon.Sexe sexe, float poids, float taille, int age) {
		super("Poisson rouge", new LinkedList<IPokemon.PokemonType>(Arrays.asList(TYPES)), nom, sexe, poids, taille, age, MAGICARPE_CRI);
	}
