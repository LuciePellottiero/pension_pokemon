...
public class Bulbizarre extends AbstractPokemon implements Plante{
	...
	public final static float BULBIZARRE_EVO_POIDS = 1000f;
	public final static float BULBIZARRE_EVO_TAILLE = 5f;
	...
	public float getEvoPoids() {
		return BULBIZARRE_EVO_POIDS;
	}

	@Override
	public float getEvoTaille() {
		return BULBIZARRE_EVO_TAILLE;
	}
