...
public class Poichigeon extends AbstractPokemon implements Vol{
	...
	public final static float POICHIGEON_EVO_POIDS = 1000f;
	public final static float POICHIGEON_EVO_TAILLE = 5f;
	...
	public float getEvoPoids() {
		return POICHIGEON_EVO_POIDS;
	}

	@Override
	public float getEvoTaille() {
		return POICHIGEON_EVO_TAILLE;
	}
